...
namespace MultipleObjects
{
    class Products
    {
        ...
        public virtual void changeMe()
        {
            ...
            setAvailable(bool.Parse(Console.ReadLine()));
            Console.Write("Quantity available = ");
            setQuantity(int.Parse(Console.ReadLine()));
        }
        ...
        public virtual void print()
        {
            ...
            Console.WriteLine($"Available: {getAvailable()}");
    ...
    class Books : Products
    {
        ...
        public override void print()
        {
            ...
            Console.WriteLine($"Format: {getFormat()}");
        }
    } // end books class
